...
import Fluid from '../../../layouts/Fluid/Fluid';
      ...
      <Box bgcolor={'alternate.main'}>
        <Container maxWidth={1500} paddingBottom={'16px !important'}>
          <Breadcrumbs aria-label="breadcrumb">
            <Link component={RouterLink} underline="hover" color="inherit" to="/blocks">
              Components
            </Link>
            <Link
              ...
              underline="hover"
              color="inherit"
              to="/blocks#js--blocks__index-section--application-ui"
            >
              Application UI
            </Link>
